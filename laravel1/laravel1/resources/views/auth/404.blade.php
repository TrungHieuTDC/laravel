...
<body>
    ...
    <div class="wrapper">
        <!-- 404 Section Start -->
        <div class="f0f--section pd--100-0" data-bg-img="img/404-img/bg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-6 col-sm-offset-0 col-xs-8 col-xs-offset-2 col-xxs-12">
                        ...
                        <div class="f0f--content">
                            <div class="title">
                                <h1 class="h1">Duong dan dang bi sai</h1>
                            </div>

                            <div class="sub-title">
                                <h2 class="h5">Khon ton tai</h2>
                            </div>
                            ...
                            <div class="note">
                                <p>Vui long quay lai trang chu.</p>
                            </div>

                            <div class="action">
                                <a href="/auth/home-1" class="btn btn-primary">Back To Home</a>
                            </div>
                        </div>
                        <!-- 404 Content End -->
                    </div>
