                ...
                <div class="container">
                    <div class="float--left float--xs-none text-xs-center">
                        ...
                        <ul class="header--topbar-info nav">
                            ...
                            <li><i class="fa fm fa-calendar"></i>Today (Sunday 27 May 2023)</li>
                        </ul>
                    ...
                    <ul class="nav">
                       ...
                       @foreach ($dataArticle->getArticle_News(5) as $value)
                            <li>
                                ...
                                <h3 class="h3"><a href="">{{$value->title}}</a></h3>
                            </li>
                       @endforeach
                    </ul>
                </div>
        ...
        <div class="main--breadcrumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span>Reatured News</span></li>
                </ul>
            </div>
        </div>
        <!-- Main Breadcrumb End -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                        <div class="post--img">
                                                            ...
                                                            <a href="#" class="cat">{{$value->title}}</a>
                                                        </div>
                                                    </div>
